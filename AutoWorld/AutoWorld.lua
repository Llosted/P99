...
loadstring(game:HttpGet("https://raw.githubusercontent.com/Qwers1221/Roblox_Scripts/master/PetSimulator99/AutoWorld/WITH_TNT/WaitForGameLoad.lua?token=" .. token))()
